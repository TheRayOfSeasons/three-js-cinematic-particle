...
import { createCollidingObjects } from '../scene-objects/colliding-objects';

const CollisionTestAnimation = ({ canvas, gui, guiAPI }) => {
  return {
    gui,
    guiAPI,
    init: function() {
      ...
      this.objects = [
        (() => {
          const collidingObjects = createCollidingObjects();
