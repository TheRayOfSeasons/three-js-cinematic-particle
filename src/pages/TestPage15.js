...
import { createAdvancedAnimatedImportedCellSpread } from './AdvancedAnimatedCellSpread';
...
const CellAnimation = canvas => {
  return {
    init: function() {
      ...
      this.objects = [
        (() => {
          const cells = createAdvancedAnimatedImportedCellSpread(this.scene, this.camera);
          cells.init();
